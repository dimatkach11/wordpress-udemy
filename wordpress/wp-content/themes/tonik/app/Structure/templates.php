...
function render_post_programmazione()
{
    template(['partials/post/programmazione', get_post_format()]);
}
add_action('theme/post/programmazione', 'Tonik\Theme\App\Structure\render_post_programmazione');
